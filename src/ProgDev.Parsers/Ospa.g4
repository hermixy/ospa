...
Elem_Type_Name             : Numeric_Type_Name | Bit_Str_Type_Name | String_Type_Name | Date_Type_Name 
                              | Time_Type_Name;
...
Derived_Type_Access        : Single_Elem_Type_Access | Array_Type_Access | Struct_Type_Access | String_Type_Access 
                              | Class_Type_Access | Ref_Type_Access | Interface_Type_Access; 
...
Type_Decl                  : Simple_Type_Decl | Subrange_Type_Decl | Enum_Type_Decl | Array_Type_Decl 
                              | Struct_Type_Decl | Str_Type_Decl | Ref_Type_Decl; 
...
Struct_Elem_Init           : Struct_Elem_Name ':=' 
...
Std_Func_Name              : 'TRUNC' | 'ABS' | 'SQRT' | 'LN' | 'LOG' | 'EXP' | 'SIN' | 'COS' | 'TAN' | 'ASIN' | 'ACOS' 
                              | 'ATAN' | 'ATAN2' | 'ADD' | 'SUB' | 'MUL' | 'DIV' | 'MOD' | 'EXPT' | 'MOVE' | 'SHL' 
                              | 'SHR' | 'ROL' | 'ROR' | 'AND' | 'OR' | 'XOR' | 'NOT' | 'SEL' | 'MAX' | 'MIN' | 'LIMIT' 
                              | 'MUX' | 'GT' | 'GE' | 'EQ' | 'LE' | 'LT' | 'NE' | 'LEN' | 'LEFT' | 'RIGHT' | 'MID' 
...
Interface_Decl             : 'INTERFACE' Interface_Type_Name Using_Directive * ( 'EXTENDS' Interface_Name_List )? 
                              Method_Prototype * 'END_INTERFACE'; 
...
Prog_Decl                  : 'PROGRAM' Prog_Type_Name 
                              ( IO_Var_Decls | Func_Var_Decls | Temp_Var_Decls | Other_Var_Decls | Loc_Var_Decls 
                              | Prog_Access_Decls )* FB_Body 'END_PROGRAM'; 
...
SFC                        : Sfc_Network +; 
Sfc_Network                : Initial_Step ( Step | Transition | Sfc_Action )*; 
...
Config_Decl                : 'CONFIGURATION' Config_Name Global_Var_Decls ? 
                              ...
                              'END_CONFIGURATION'; 
Resource_Decl              : 'RESOURCE' Resource_Name 'ON' Resource_Type_Name Global_Var_Decls ? Single_Resource_Decl 
                              'END_RESOURCE'; 
...
Task_Init                  : '(' ( 'SINGLE' ':=' Data_Source ',' )? ( 'INTERVAL' ':=' Data_Source ',' )? 
...
IL_Instruction             : ( IL_Label ':' )? ( IL_Simple_Operation | IL_Expr | IL_Jump_Operation | IL_Invocation 
                              | IL_Formal_Func_Call | IL_Return_Operator )? EOL +; 
...
IL_Simple_Operator         : 'LD' | 'LDN' | 'ST' | 'STN' | 'ST?' | 'NOT' | 'S' | 'R' | 'S1' | 'R1' | 'CLK' | 'CU' 
                              | 'CD' | 'PV' | 'IN' | 'PT' | IL_Expr_Operator; 
IL_Expr_Operator           : 'AND' | '&' | 'OR' | 'XOR' | 'ANDN' | '&N' | 'ORN' | 'XORN' | 'ADD' | 'SUB' | 'MUL' 
                              | 'DIV' | 'MOD' | 'GT' | 'GE' | 'EQ' | 'LT' | 'LE' | 'NE'; 
...
Invocation                 : ( FB_Instance_Name | Method_Name | 'THIS' 
                              | ( ( 'THIS' '.' )? ( ( ( FB_Instance_Name | Class_Instance_Name ) '.' )+ ) 
                              Method_Name ) ) '(' ( Param_Assign ( ',' Param_Assign )* )? ')'; 
...
IF_Stmt                    : 'IF' Expression 'THEN' Stmt_List ( 'ELSIF' Expression 'THEN' Stmt_List )* 
...
FBD_Network                : 'TODO-FBD'; 
Other_Languages            : 'TODO-OTHER';
